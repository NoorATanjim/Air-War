...
void iSpecialKeyboard(unsigned char key)
{
	...
	{  
		if(key == GLUT_KEY_UP)
		{
			cop_y = min(600,cop_y+20);//CHANGE KORTE HOBE
		}
		...
		{
			cop_x =  max(0,cop_x-10);//CHANGE KORTE HO
		}
...
int main()
{
	iInitialize(Swidth, Slength, "Air War");
